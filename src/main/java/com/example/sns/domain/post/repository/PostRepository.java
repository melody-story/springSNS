...
//        var posts = namedParameterJdbcTemplate.query(sql, params, ROW_MAPPER); // 싱글로 만들기 1
//        Post nullablePost = DataAccessUtils.singleResult(posts);
//        return Optional.ofNullable(nullablePost);
        Post nullablePost = namedParameterJdbcTemplate.queryForObject(sql, params, ROW_MAPPER);// 싱글로 만들기 2
        return Optional.ofNullable(nullablePost);
    }
...
//        if (updatedCount == 0) { // 업데이트 count 0이므로 업데이트 실패
